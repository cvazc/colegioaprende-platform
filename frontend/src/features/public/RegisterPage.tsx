...
export function RegisterPage() {
  ...
  return (
    <Card>
      <h1 className="text-xl font-bold text-slate-900">Registro de Prospecto</h1>
      <p className="mt-1 text-sm text-slate-600">Al completar registro se genera el flujo de pago.</p>
